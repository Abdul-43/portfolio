          ...
          <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            ...
            <Col md={4} className="project-card">
              <ProjectCard
                ...
                description="Developed a ReactJS admin dashboard for efficient management and monitoring deals, users, products and revenue analytics, utilizing Recharts for dynamic data visualization. This application is crafted with fully responsive."
                ghLink="https://react-dashboard-vite.netlify.app"
                feLink="https://github.com/Abdul-43/react-dashboard.git"
                beLink=""
